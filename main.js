...
edu.textContent="Eucation Details:";
...
function education(Educa) {
  for (i in Educa) {
    ...
    li.textContent=Educa[i].college[j];//each object lo college
    ul.appendChild(li);
    e1.appendChild(ul);
    edu.appendChild(e1);
    }
...
function skill(skills){
  ...
  skill_title.textContent="Techanical skills";
